        ...
        <section className="bg-primary">
          <div className="max-w-4xl mx-auto px-6 lg:px-8 py-16 lg:py-24 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center mt-10">
              <a href={SIGNAL_URL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-primary-foreground text-primary px-8 py-4 text-sm font-sans font-medium hover:opacity-90 transition-opacity">
                <Image src="/signal.jpeg" alt="Signal" width={16} height={16} className="w-4 h-4" /> {t.cta.button}
              </a>
              <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 border border-primary-foreground/30 text-primary-foreground px-8 py-4 text-sm font-sans hover:bg-primary-foreground/10 transition-colors">
        ...
        <section className="bg-primary">
          <div className="max-w-4xl mx-auto px-6 lg:px-8 py-16 lg:py-24 text-center">
            ...
            <div className={`flex flex-col sm:flex-row gap-3 justify-center mt-10 ${rtl ? "sm:flex-row-reverse" : ""}`}>
              <a href={SIGNAL_URL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-primary-foreground text-primary px-8 py-4 text-sm font-sans font-medium hover:opacity-90 transition-opacity">
                <Image src="/signal.jpeg" alt="Signal" width={16} height={16} className="w-4 h-4" /> {t.cta.button}
              </a>
              <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 border border-primary-foreground/30 text-primary-foreground px-8 py-4 text-sm font-sans hover:bg-primary-foreground/10 transition-colors">
                <Image src="/whatsapp.svg" alt="WhatsApp" width={16} height={16} className="w-4 h-4" /> {t.cta.whatsapp}
              </a>
            </div>
          </div>
